...
exports.FetchLoader = void 0;
const FetchAbortedReason_1 = require("./FetchAbortedReason");
...
class FetchLoader {
    ...
    abort() {
        ...
        this.cmResponse.abortReason = FetchAbortedReason_1.FetchAbortedReason.USER;
    ...
    setTimeout(timeout) {
        ...
        this.timeoutID = window.setTimeout(() => {
            var _a;
            if (this.cmResponse) {
                this.cmResponse.abortReason = FetchAbortedReason_1.FetchAbortedReason.TIMEOUT;
            }
            (_a = this.abortController) === null || _a === void 0 ? void 0 : _a.abort();
        }, timeout);
    }
